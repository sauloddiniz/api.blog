...
import com.api.blog.exception.domain.usuario.EmailNaoEncontradoException;
...
public class ExceptionHandling {
	...
	@ExceptionHandler(PostNaoPertenceAoUsuarioException.class)
	public ResponseEntity<HttpResponse> postNaoPertenceAoUsuarioException(PostNaoPertenceAoUsuarioException exception) {
		return createHttpRespose(HttpStatus.UNAUTHORIZED, exception.getMessage());
	}
	
	@ExceptionHandler(PostNaoEncontradoException.class)
	public ResponseEntity<HttpResponse> postNaoEncontradoException(PostNaoEncontradoException exception) {
		return createHttpRespose(HttpStatus.BAD_REQUEST, exception.getMessage());
	}
